$(function(){
  ...
  function toggleSideBar(_this){
    ...
    if(w.hasClass("sb-collapsed")){
      $(".glyphicon",b).addClass("glyphicon-chevron-left").removeClass("glyphicon-chevron-right");
      w.removeClass("sb-collapsed");
    }else{
      $(".glyphicon",b).removeClass("glyphicon-chevron-left").addClass("glyphicon-chevron-right");
